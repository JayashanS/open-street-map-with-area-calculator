...
const MapComponent = () => {
  ...
  useEffect(() => {
    ...
    const style = new Style({
        fill: new Fill({
          color: 'rgba(255, 255, 255, 0.2)', // fill color for polygons
        }),
        stroke: new Stroke({
          color: 'rgba(255, 0, 0, 0.5)', // stroke color for lines and polygon outlines
          lineDash: [10, 10],
          width: 2,
        }),
        image: new CircleStyle({
          ...
          fill: new Fill({
            color: 'rgba(255, 255, 255, 0.2)', //  fill color for points
          }),
        }),
      });
